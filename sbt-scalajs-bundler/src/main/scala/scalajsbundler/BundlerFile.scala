...
object BundlerFile {
  ...
  /** A library-mode entrypoint file
    ...
    */
  case class EntryPoint(application: Application, file: java.io.File) extends Internal with WebpackInput {
  ...
  /** A webpack configuration file.
    ...
    */
  case class WebpackConfig(application: Application, file: java.io.File) extends Internal {
    def project: String = application.project
    ...
    /** Returns library from a set of cached files By convention the first element is the `file` and the rest are the
      * assets
      */
    ...
    /** Returns an application bundle from a set of cached files By convention the first element is the `file` and the
      * rest are the assets
      */
  ...
  /** The Scala.js application itself, aka -fastopt.js or -opt.js
    ...
    */
  case class Application(project: String, file: File, assets: List[java.io.File]) extends Public with WebpackInput {
  ...
  /** A webpack loader file. Allows an [[Application]] to access the dependencies bundled into a [[Library]]
    ...
    *   Loader file
    */
  case class Loader(application: Application, file: java.io.File) extends Public {
  ...
  /** A fully self-contained application bundle, including all dependencies.
    ...
    *   All the assets on the application
    */
  case class ApplicationBundle(project: String, file: File, assets: List[java.io.File]) extends Public {
